...
router.get("/welcome", authMiddleware.requireAuth, controller.welcome);
...
router.get("/delete-sensor", controller.deleteSensorData);
router.get("/delete-measure", controller.deleteMeasurement);
router.get("/delete-measure-patient", controller.deleteMePatient);
